...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1961.0, 470.9000244140625, 111.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 1961.0, 443.200042724609375, 81.0, 22.0 ],
					"text" : "snapshot~ 33"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1961.0, 414.4000244140625, 63.0, 22.0 ],
					"text" : "cycle~ 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 432.0, 262.0, 34.0, 22.0 ],
					"text" : "vol 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1608.39990234375, 242.4000244140625, 39.0, 20.0 ],
					"text" : "dial 8"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1483.800048828125, 312.9000244140625, 39.0, 20.0 ],
					"text" : "dial 3"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1384.0, 312.9000244140625, 39.0, 20.0 ],
					"text" : "dial 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 976.800048828125, 999.800048828125, 125.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 1069.199951171875, 283.79998779296875, 137.0, 22.0 ],
					"text" : "jit.matrix 4 char 640 480"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 371.20001220703125, 476.79998779296875, 137.0, 22.0 ],
					"text" : "jit.matrix 4 char 640 480"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 536.0, 234.0, 24.0, 24.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 536.0, 262.0, 39.0, 22.0 ],
					"text" : "rate 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 479.20001220703125, 175.0, 50.0, 22.0 ],
					"varname" : "number[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 479.20001220703125, 205.0, 105.0, 22.0 ],
					"text" : "scale 11 116 -5. 5."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 479.20001220703125, 234.0, 50.0, 22.0 ],
					"varname" : "number"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 479.20001220703125, 262.0, 46.0, 22.0 ],
					"text" : "rate $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 947.60003662109375, 486.400054931640625, 40.0, 40.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 931.0, 408.800018310546875, 40.0, 40.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 1608.39990234375, 591.70001220703125, 41.0, 22.0 ],
					"text" : "jit.rota"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 947.60003662109375, 529.20001220703125, 85.0, 22.0 ],
					"text" : "slide_down $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 931.0, 451.600006103515625, 70.0, 22.0 ],
					"text" : "slide_up $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 431.800018310546875, 897.20001220703125, 45.0, 22.0 ],
					"text" : "jit.slide"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 371.20001220703125, 436.5, 41.0, 32.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 393.20001220703125, 318.5, 53.0, 22.0 ],
					"text" : "jit.movie"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 774.20001220703125, 168.199981689453125, 106.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 656.800048828125, 168.199981689453125, 106.0, 22.0 ],
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 250.04998779296875, 422.25, 391.70001220703125, 422.25 ],
					"order" : 1,
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 545.5, 305.25, 402.70001220703125, 305.25 ],
					"source" : [ "obj-131", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 380.70001220703125, 573.100006103515625, 120.149993896484375, 573.100006103515625 ],
					"order" : 2,
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-77", 0 ],
					"midpoints" : [ 380.70001220703125, 562.0, 134.149993896484375, 562.0 ],
					"order" : 1,
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 402.70001220703125, 395.050003051757812, 1277.166666666666742, 395.050003051757812 ],
					"order" : 0,
					"source" : [ "obj-23", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 940.5, 796.918991088867188, 1427.5, 796.918991088867188 ],
					"order" : 0,
					"source" : [ "obj-34", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 940.5, 850.900009155273438, 441.300018310546875, 850.900009155273438 ],
					"order" : 1,
					"source" : [ "obj-34", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-121", 0 ],
					"midpoints" : [ 957.10003662109375, 796.718994140625, 1427.5, 796.718994140625 ],
					"order" : 0,
					"source" : [ "obj-35", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-31", 0 ],
					"midpoints" : [ 957.10003662109375, 850.900009155273438, 441.300018310546875, 850.900009155273438 ],
					"order" : 1,
					"source" : [ "obj-35", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-23", 0 ],
					"midpoints" : [ 488.70001220703125, 305.25, 402.70001220703125, 305.25 ],
					"source" : [ "obj-36", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-23", 0 ],
					"midpoints" : [ 351.70001220703125, 211.350006103515625, 402.70001220703125, 211.350006103515625 ],
					"source" : [ "obj-7", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 0 ],
					"midpoints" : [ 134.149993896484375, 152.900009155273438, 666.300048828125, 152.900009155273438 ],
					"order" : 1,
					"source" : [ "obj-9", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 0 ],
					"midpoints" : [ 134.149993896484375, 152.900009155273438, 783.70001220703125, 152.900009155273438 ],
					"order" : 0,
					"source" : [ "obj-9", 0 ]
				}
